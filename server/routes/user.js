...
router.get('/from-team:teamID', onTeam, (req, res) => {
...
router.get('/search/:name', isAuthenticated, (req, res) => {
...
router.put('/unfollow', isAuthenticated, (req, res) => {
...
router.get('/follow', isAuthenticated, (req, res) => {
...
router.get('/details/:userID', isAuthenticated, teamMates, (req, res) => {
...
router.get('/my-details', isAuthenticated, (req, res) => {
...
router.put('/phone', isAuthenticated, (req, res) => {
...
// set your location
router.put('/location', isAuthenticated, (req, res) => {
...
// PUT api/user/skype
// set your skype
router.put('/skype', isAuthenticated, (req, res) => {
...
router.put('/pic', isAuthenticated, (req, res) => {
