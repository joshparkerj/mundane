...
router.post('/approval', isAuthorized, isManager, (req, res) => {
...
router.post('/join', isAuthorized, alreadyMember, (req, res) => {
...
router.post('/join-name', isAuthorized, teamExists, (req, res) => {
...
// PUT /api/team/quit
// quit the team
router.put('/quit', isAuthorized, (req, res) => {
...
router.get('/by-name/:name', isAuthorized, (req, res) => {
...
router.get('/organization/:organization', isAuthorized, (req, res) => {
...
router.get('/by-id/:teamID', isAuthorized, (req, res) => {
...
router.get('/us/:theirID', isAuthorized, (req, res) => {
...
router.put('/organization', isAuthorized, isManager, (req, res) => {
...
router.put('/name', isAuthorized, isManager, (req, res) => {
...
router.put('/boot', isAuthorized, isManager, (req, res) => {
...
router.delete('/:teamID', isAuthorized, isManager, (req, res) => {
